...
export default function FetchCSVData() {
    ...
    const fetchConfig = async () => {
        try {
            setIsConfigLoading(true); // Set loading to true
            ...
            setIsConfigLoading(false); // Set loading to false
        }
    };
    ...
    const fetchCSVData = useCallback(async () => {
        try {
            setIsDataLoading(true); // Set loading to true
        ...
        //   setLoading(false); // Set loading to false after fetching data
            ...
            setIsDataLoading(false); // Set loading to false
        }
